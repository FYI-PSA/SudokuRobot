...
def servermain(filename):
    ...
    if res != 0:
        err_message: str = ("There's an error in:  1. The image quality - 2. The puzzle configuration - 3. The program\n"
        ...
        "If you still face this error, check the validty of your puzzles.\n"
        "If your image and puzzle are correct, report the issue to the admin on Telegram @FYI-PSA")
